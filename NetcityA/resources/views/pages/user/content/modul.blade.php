                ...
                <div class="col-md-12 col-lg-8 main-content">
                    <div class="row my-4">
                        <div class="row-md-6 mb-4 d-flex justify-content-center align-items-center">
                            <img src="{{ asset('ImgModul/'.$moduls->gambar_modul) }}" alt="Image placeholder" class="img-fluid rounded" style="max-width: 300px; max-height: 200px;">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 sidebar">
                    <div class="sidebar-box">
                        ...
                        <ul class="categories">
                            ...
                            <li><a href="{{ route('user.kategori',$category->id_kategori) }}" style="color: black; text-decoration: none; ">{{ $category->nama_kategori }}<span>{{ count($category->modul) }}</span></a></li>
